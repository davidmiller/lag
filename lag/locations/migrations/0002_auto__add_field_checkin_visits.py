...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Checkin.visits'
        db.add_column('locations_checkin', 'visits', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Checkin.visits'
        db.delete_column('locations_checkin', 'visits')

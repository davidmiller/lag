...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lair.created'
        db.add_column('locations_lair', 'created', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'Place.created'
        db.add_column('locations_place', 'created', self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Lair.created'
        db.delete_column('locations_lair', 'created')

        # Deleting field 'Place.created'
        db.delete_column('locations_place', 'created')
    ...
    models = {
        ...
        'players.player': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lair': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['locations.Lair']", 'null': 'True', 'blank': 'True'}),

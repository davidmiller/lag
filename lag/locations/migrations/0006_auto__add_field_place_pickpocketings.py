...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.pickpocketings'
        db.add_column('locations_place', 'pickpocketings', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.pickpocketings'
        db.delete_column('locations_place', 'pickpocketings')

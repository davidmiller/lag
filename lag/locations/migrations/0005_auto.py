...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field current_visitors on 'Place'
        db.create_table('locations_place_current_visitors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('place', models.ForeignKey(orm['locations.place'], null=False)),
            ('player', models.ForeignKey(orm['players.player'], null=False))
        ))
        db.create_unique('locations_place_current_visitors', ['place_id', 'player_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field current_visitors on 'Place'
        db.delete_table('locations_place_current_visitors')

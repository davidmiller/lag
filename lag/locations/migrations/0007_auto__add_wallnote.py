...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WallNote'
        db.create_table('locations_wallnote', (
        ...
        db.send_create_signal('locations', ['WallNote'])


    def backwards(self, orm):
        
        # Deleting model 'WallNote'
        db.delete_table('locations_wallnote')

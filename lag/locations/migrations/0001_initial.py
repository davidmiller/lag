...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('locations_place', (
            ...
            ('lat', self.gf('django.db.models.fields.FloatField')()),
            ('lon', self.gf('django.db.models.fields.FloatField')()),
            ('region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Region'], null=True)),
        ))
        db.send_create_signal('locations', ['Place'])

        # Adding model 'Checkin'
        db.create_table('locations_checkin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('locations', ['Checkin'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('locations_checkin')

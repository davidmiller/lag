...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PlaceType.epic_percentage'
        db.add_column('locations_placetype', 'epic_percentage', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PlaceType.mythic_percentage'
        db.add_column('locations_placetype', 'mythic_percentage', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'PlaceType.artifact_percentage'
        db.add_column('locations_placetype', 'artifact_percentage', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PlaceType.epic_percentage'
        db.delete_column('locations_placetype', 'epic_percentage')

        # Deleting field 'PlaceType.mythic_percentage'
        db.delete_column('locations_placetype', 'mythic_percentage')

        # Deleting field 'PlaceType.artifact_percentage'
        db.delete_column('locations_placetype', 'artifact_percentage')

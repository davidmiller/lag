...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Pickpocketing'
        db.create_table('items_pickpocketing', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pickpocketer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['players.Player'])),
            ('victim', self.gf('django.db.models.fields.related.ForeignKey')(related_name='victim', to=orm['players.Player'])),
            ('place', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['locations.Place'])),
            ('occurred', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('victim_informed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal('items', ['Pickpocketing'])


    def backwards(self, orm):
        
        # Deleting model 'Pickpocketing'
        db.delete_table('items_pickpocketing')
    ...
    models = {
        ...
        'items.pickpocketing': {
            'Meta': {'object_name': 'Pickpocketing'},
            'artifact': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['items.Artifact']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'occurred': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'pickpocketer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['players.Player']"}),
            ...
            'victim': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'victim'", 'to': "orm['players.Player']"}),
            'victim_informed': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'items.treasure': {
        ...
        'locations.place': {
            ...
            'current_visitors': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'current_visitors'", 'symmetrical': 'False', 'to': "orm['players.Player']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

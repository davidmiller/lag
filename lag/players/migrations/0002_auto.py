...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field interactions_seen on 'Player'
        db.create_table('players_player_interactions_seen', (
        ...
        db.create_unique('players_player_interactions_seen', ['player_id', 'npcinteraction_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field interactions_seen on 'Player'
        db.delete_table('players_player_interactions_seen')

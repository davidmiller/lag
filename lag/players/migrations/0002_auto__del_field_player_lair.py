...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Player.lair'
        db.delete_column('players_player', 'lair_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Player.lair'
        db.add_column('players_player', 'lair', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['locations.Lair'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'players.player': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lair': ('django.db.models.fields.related.ManyToManyField', [], {'default': 'None', 'to': "orm['locations.Lair']", 'null': 'True', 'symmetrical': 'False', 'blank': 'True'}),

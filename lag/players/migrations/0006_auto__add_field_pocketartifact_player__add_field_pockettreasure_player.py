...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PocketArtifact.player'
        db.add_column('players_pocketartifact', 'player', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['players.Player'], null=True, blank=True), keep_default=False)

        # Adding field 'PocketTreasure.player'
        db.add_column('players_pockettreasure', 'player', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['players.Player'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PocketArtifact.player'
        db.delete_column('players_pocketartifact', 'player_id')

        # Deleting field 'PocketTreasure.player'
        db.delete_column('players_pockettreasure', 'player_id')

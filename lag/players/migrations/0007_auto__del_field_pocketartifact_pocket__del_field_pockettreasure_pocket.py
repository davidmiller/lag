...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PocketArtifact.pocket'
        db.delete_column('players_pocketartifact', 'pocket_id')

        # Deleting field 'PocketTreasure.pocket'
        db.delete_column('players_pockettreasure', 'pocket_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PocketArtifact.pocket'
        raise RuntimeError("Cannot reverse this migration. 'PocketArtifact.pocket' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'PocketTreasure.pocket'
        raise RuntimeError("Cannot reverse this migration. 'PocketTreasure.pocket' and its values cannot be restored.")
